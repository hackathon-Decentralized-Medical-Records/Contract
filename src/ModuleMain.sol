...
contract ModuleMain is ModuleReservation, ModuleContribution, ModuleFund {
    constructor(
        ...
        ModuleReservation(subscriptionId, gasLane, callbackGasLimit, vrfCoordinatorV2, interval)
        ModuleContribution(subscriptionId, gasLane, callbackGasLimit, vrfCoordinatorV2, interval)
        ModuleFund(PriceFeed)
    {}
}
